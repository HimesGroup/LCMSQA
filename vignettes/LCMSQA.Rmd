...
using a Shiny application. It uses the
*[xcms](https://bioconductor.org/packages/3.15/xcms)* workflow for data import,
visualization, and feature detection of internal standards or known metabolites
that can be used to evaluate and adapt the peak detection settings.
...
*[BiocParallel](https://bioconductor.org/packages/3.15/BiocParallel)* to save
...
links:
[QC_sample1.mzML](https://github.com/HimesGroup/package_example_data/raw/main/LCMSQA/example1.mzML),
[QC_sample2.mzML](https://github.com/HimesGroup/package_example_data/raw/main/LCMSQA/example2.mzML),
and
[IS_info.csv](https://github.com/HimesGroup/package_example_data/raw/main/LCMSQA/IS_info.csv)
...
1. (required) mass-spectrometry data files in open formats: AIA/ANDI NetCDF,
  mzXML, mzData and mzML

Check *[msconvert](https://proteowizard.sourceforge.io/tools/msconvert.html)* if
...
### 2. Peak picking using the [centWave](https://rdrr.io/bioc/xcms/man/findChromPeaks-centWave.html) method
...
### 3. Peak grouping using the [peak density](https://rdrr.io/bioc/xcms/man/groupChromPeaks-density.html) method
